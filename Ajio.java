class Ajio{
public static String ajioLogin(String firstName, String lastName, String phoneNumber, String emailId, String address, String pincode)
{
String ref = null;
boolean loginInfo = checkingPersonDetails(firstName, lastName, phoneNumber, address, emailId, pincode);
if(loginInfo==true)
ref="user ajioLogin successful";
else
ref="user ajioLogin unsuccessful";
return ref ;
}
